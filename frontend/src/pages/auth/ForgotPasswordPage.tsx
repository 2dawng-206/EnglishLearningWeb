    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <p className="font-body text-sm text-ink-700">
          If an account exists for <span className="font-medium text-ink-950">{email}</span>, we’ve
          sent a link to reset your password. The link expires in 30 minutes.
        </p>
        <Link to="/login" className="font-body text-sm font-medium text-amber-600 hover:underline">
          Back to log in
        </Link>
      </div>
    );
